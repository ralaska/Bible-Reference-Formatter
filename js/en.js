	...
	var styles = Object.freeze({
		"niv-long": {
			...
			books: {
				...
				// Ranges
				"1Sam-2Sam": ["1 Samuel—2 Samuel"],
				"1Kgs-2Kgs": ["1 Kings—2 Kings"],
				"1Chr-2Chr": ["1 Chronicles—2 Chronicles"],
				"1Cor-2Cor": ["1 Corinthians—2 Corinthians"],
				"1Thess-2Thess": ["1 Thessalonians—2 Thessalonians"],
				"1Tim-2Tim": ["1 Timothy—2 Timothy"],
				"1Pet-2Pet": ["1 Peter—2 Peter"],
				"1John-2John": ["1 John—2 John"],
				"1John-3John": ["1 John—3 John"],
				"2John-3John": ["2 John—3 John"],
				...
				// Sequences
				"1Sam,2Sam": ["1 Samuel and 2 Samuel"],
				"1Kgs,2Kgs": ["1 Kings and 2 Kings"],
				"1Chr,2Chr": ["1 Chronicles and 2 Chronicles"],
				"1Cor,2Cor": ["1 Corinthians and 2 Corinthians"],
				"1Thess,2Thess": ["1 Thessalonians and 2 Thessalonians"],
				"1Tim,2Tim": ["1 Timothy and 2 Timothy"],
				"1Pet,2Pet": ["1 Peter and 2 Peter"],
				"1John,2John": ["1 John and 2 John"],
				"1John,3John": ["1 John and 3 John"],
				"2John,3John": ["2 John and 3 John"],
		...
		"niv-short": {
			...
			books: {
				...
				"Ps.$chapters": ["Ps", "Pss"],
				// Ranges
				"1Sam-2Sam": ["1 Sam—2 Sam"],
				"1Kgs-2Kgs": ["1 Kgs—2 Kgs"],
				"1Chr-2Chr": ["1 Chr—2 Chr"],
				"1Cor-2Cor": ["1 Cor—2 Cor"],
				"1Thess-2Thess": ["1 Thess—2 Thess"],
				"1Tim-2Tim": ["1 Tim—2 Tim"],
				"1Pet-2Pet": ["1 Pet—2 Pet"],
				"1John-2John": ["1 John—2 John"],
				"1John-3John": ["1 John—3 John"],
				"2John-3John": ["2 John—3 John"],
				"1Macc-2Macc": ["1—2 Macc"],
				"1Macc-3Macc": ["1—3 Macc"],
				"1Macc-4Macc": ["1—4 Macc"],
				"2Macc-3Macc": ["2—3 Macc"],
				"2Macc-4Macc": ["2—4 Macc"],
				"3Macc-4Macc": ["3—4 Macc"],
				"1Esd-2Esd": ["1—2 Esd"],
				// Sequences
				"1Sam,2Sam": ["1 Sam and 2 Sam"],
				"1Kgs,2Kgs": ["1 Kgs and 2 Kgs"],
				"1Chr,2Chr": ["1 Chr and 2 Chr"],
				"1Cor,2Cor": ["1 Cor and 2 Cor"],
				"1Thess,2Thess": ["1 Thess and 2 Thess"],
				"1Tim,2Tim": ["1 Tim and 2 Tim"],
				"1Pet,2Pet": ["1 Pet and 2 Pet"],
				"1John,2John": ["1 John and 2 John"],
				"1John,2John,3John": ["1 John, 2 John, and 3 John"],
				"1John,3John": ["1 John and 3 John"],
				"2John,3John": ["2 John and 3 John"],
				"1Macc,2Macc": ["1 and 2 Macc"],
				"1Macc,2Macc,3Macc": ["1, 2, and 3 Macc"],
				"1Macc,2Macc,3Macc,4Macc": ["1, 2, 3, and 4 Macc"],
				"1Macc,3Macc": ["1 and 3 Macc"],
				"1Macc,3Macc,4Macc": ["1, 3, and 4 Macc"],
				"1Macc,4Macc": ["1 and 4 Macc"],
				"2Macc,3Macc": ["2 and 3 Macc"],
				"2Macc,3Macc,4Macc": ["2, 3, and 4 Macc"],
		...
		"nlt-short": {
			...
			books: {
				...
				"1Esd-2Esd": ["1—2 Esd"],
				// Sequences
				"1Sam,2Sam": ["1 and 2 Sam"],
				"1Kgs,2Kgs": ["1 and 2 Kgs"],
				"1Chr,2Chr": ["1 and 2 Chr"],
				"1Cor,2Cor": ["1 and 2 Cor"],
				"1Thess,2Thess": ["1 and 2 Thes"],
				"1Tim,2Tim": ["1 and 2 Tim"],
				"1Pet,2Pet": ["1 and 2 Pet"],
				"1John,2John": ["1 and 2 Jn"],
				"1John,2John,3John": ["1, 2, and 3 Jn"],
				"1John,3John": ["1 and 3 Jn"],
				"2John,3John": ["2 and 3 Jn"],
				"1Macc,2Macc": ["1 and 2 Macc"],
				"1Macc,2Macc,3Macc": ["1, 2, and 3 Macc"],
				"1Macc,2Macc,3Macc,4Macc": ["1, 2, 3, and 4 Macc"],
				"1Macc,3Macc": ["1 and 3 Macc"],
		...
		"esv-short": {
			...
			books: {
				...
				"1Sam,2Sam": ["1 and 2 Sam."],
				"1Kgs,2Kgs": ["1 and 2 Kings"],
				"1Chr,2Chr": ["1 and 2 Chron."],
				"1Cor,2Cor": ["1 and 2 Cor."],
				"1Thess,2Thess": ["1 and 2 Thess."],
				"1Tim,2Tim": ["1 and 2 Tim."],
				"1Pet,2Pet": ["1 and 2 Pet."],
				"1John,2John": ["1 and 2 John"],
...
/***/ function(module, exports) {
	...
	function OsisFormatter() {
		...
		function format(osisString, osisContext) {
			var tokens = createTokens(osisString, osisContext);
			var out = [];
		...
		function tokenize(osisString, osisContext) {
			var tokens = createTokens(osisString, osisContext);
			var out = [];
			for (var i = 0, max = tokens.length; i < max; i++) {
				var token = tokens[i];
		...
		function createTokens(osisString, osisContext) {
		...
		function formatToken(token) {
			...
			var bookProperties = ["bookRange", "bookSequence"];
			for (var i = 0; i <= 1; i++) {
				// This somewhat convoluted syntax is to satisfy Flow.
				var property = bookProperties[i];
				if (typeof token[property] !== "string") {
					continue;
				}
				var book = books[token[property]];
			...
			var out = [];
			for (var _i = 0, max = token.parts.length; _i < max; _i++) {
				out.push(formatPart(token, token.parts[_i]));
			}
			return out.join("");
		}
		...
		function getBestOption(splitChar, option, position) {
		...
		function annotateFirstToken(token) {
		...
		function addBookSequence(token, sequenceArray, tokens) {
			...
			while (sequenceArray.length > 1) {
				...
				if (typeof books[_bookSequence] !== "undefined" && typeof books[_bookSequence][0] === "string") {
					token.bookSequence = _bookSequence;
		...
		function annotateTokenParts(parts) {
			...
			for (var _i2 = 0; _i2 < max; _i2++) {
				...
				parts[_i2].laters = laters.filter(function (value) {
					return value !== ".";
				});
			}
		}
		...
		function osisBookWithContext(b, c, v, isSingleChapter, omitChapter, context, token) {
			...
			var returnSingleBook = v === undefined && isSingleChapter === true && options.singleChapterFormat === "b";
